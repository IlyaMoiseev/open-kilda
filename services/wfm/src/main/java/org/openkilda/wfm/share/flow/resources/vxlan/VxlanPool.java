...
public class VxlanPool implements EncapsulationResourcesProvider<VxlanEncapsulation> {
     ...
     */
    @Override
    public VxlanEncapsulation allocate(Flow flow, PathId pathId) {
    ...
    public void deallocate(PathId pathId) {
        transactionManager.doInTransaction(() ->
                vxlanRepository.findByPathId(pathId)
     ...
     */
    @Override
    public Optional<VxlanEncapsulation> get(PathId pathId) {
        Collection<Vxlan> vxlans = vxlanRepository.findByPathId(pathId);

...
public class IslLatencyBolt extends AbstractBolt {
    ...
    private final long latencyUpdateIntervalInMilliseconds;
    private final long latencyUpdateTimeRangeInMilliseconds;
    ...
    private Map<IslKey, Boolean> roundTripLatencyIsSet;
